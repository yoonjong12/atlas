...
```
ToolSearch({ query: "select:mcp__plugin_atlas_atlassian__jira_search,mcp__plugin_atlas_atlassian__jira_get_issue" })
```
...
```
ToolSearch({ query: "select:mcp__plugin_atlas_atlassian__jira_add_comment" })
```
...
```
ToolSearch({ query: "select:mcp__plugin_atlas_atlassian__jira_create_issue" })
```
...
```
ToolSearch({ query: "select:mcp__plugin_atlas_atlassian__jira_create_issue_link" })
```
